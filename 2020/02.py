...
password_list = [str(PW_check) for PW_check in split_input]
...
for password in password_list:
    ...
    if counter < min or counter > max:
        wrong_pws += 1
    else:
        correct_pws += 1

print(f'Correct: {correct_pws}\nWrong: {wrong_pws}')
...
for password in password_list:
    ...
    position_one = int(min_max[0])
    position_two = int(min_max[1])
    ...
    for x in split_pw[0]:
        if x.isalpha():
            letter_check = x
    print(letter_check)
    password_1 = split_pw[1].strip()
    print(len(password_1))
    print(password_1[position_one-1])
    print(password_1[position_two-1])
    print(password_1)
    if password_1[position_one-1] == letter_check and password_1[position_two-1] == letter_check:
        wrong_pws += 1
        print("Wrong")
    elif password_1[position_one-1] != letter_check and password_1[position_two-1] == letter_check:
        correct_pws += 1
        print("Correct")
    elif password_1[position_one-1] == letter_check and password_1[position_two-1] != letter_check:
        correct_pws += 1
